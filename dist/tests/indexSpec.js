...
describe('testing endpoints', function () {
    ...
    describe('checking the main route', function () {
        ...
        it('should return a wrong message for filenmae not found', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var res
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('pass all the tests for the image process function ', function () {
        it('should return a wrong message if the file name is not accessable', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var res
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                imageProcess_1.default('abdelrahman', 200, 200),
                            ]
                        case 1:
                            res = _a.sent()
                            expect(res).toEqual(
