        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    imagePath = path_1.default.resolve(
                        './',
                        'assets',
                        'full',
                        queryFilename + '.jpg'
                    )
                    outputImagePath = path_1.default.resolve(
                        './',
                        'assets',
                        'thumb',
                        queryFilename + queryWidth + '-' + queryHeight + '.jpg'
                    )
                    outputImagePathDir = path_1.default.resolve(
                        './',
                        'assets',
                        'thumb'
                    )
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/,
                        isAccessable_1.default(newImageFullPath),
                    ]
                case 2:
